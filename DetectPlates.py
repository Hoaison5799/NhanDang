...
PLATE_HEIGHT_PADDING_FACTOR = 1.35 #2.7
...
def detectPlatesInScene(imgOriginalScene):
    ...
    if Main.showSteps == True: # show steps #######################################################
        cv2.imwrite("BienDoi/1a - Gray.jpg", imgGrayscaleScene)
        cv2.imwrite("BienDoi/1b - Thresh.jpg", imgThreshScene)
    # end if # show steps #########################################################################
    ...
    if Main.showSteps == True: # show steps #######################################################
        ...
        cv2.imwrite("BienDoi/2b.jpg", imgContours)
    # end if # show steps #########################################################################

            # given a list of all possible chars, find groups of matching chars
            # in the next steps each group of matching chars will attempt to be recognized as a plate
    listOfPossibleCharsInScene.sort(key=lambda matchingChar: matchingChar.intBoundingRectX)
    listOfPossibleCharsInScene.sort(key=lambda matchingChar: matchingChar.intBoundingRectY)
    ...
    if Main.showSteps == True: # show steps #######################################################
        ...
        cv2.imwrite("BienDoi/3.jpg", imgContours)
    # end if # show steps #########################################################################
...
def findPossibleCharsInScene(imgThresh):
    ...
    if Main.showSteps == True: # show steps #######################################################
        ...
        cv2.imwrite("BienDoi/2a.jpg", imgContours)
    # end if # show steps #########################################################################
...
def extractPlate(imgOriginal, listOfMatchingChars):
    ...
    ptPlateCenter = fltPlateCenterX, fltPlateCenterY + 7
  ...
  #  fltCorrectionAngleInDeg = 1- fltCorrectionAngleInDeg
  ...
  #  imgCropped = cv2.resize(imgCropped, (0, 0), fx=1.1, fy=1.1)
